    ...
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      ...
      <body>
        <main class="layout-content">        
          ...
          <div class="text-8">
            <xsl:text>&lt;</xsl:text><a href="mailto:jannis.bloem@gmail.com"><xsl:value-of select="/atom:feed/atom:author/atom:email" /></a><xsl:text>&#160;</xsl:text><a href=""><xsl:attribute name="href"><xsl:value-of select="/atom:feed/atom:link[3]/@href"/></xsl:attribute>0x3F31D84F-pub.asc</a>, (<a href=""><xsl:attribute name="href"><xsl:value-of select="/atom:feed/atom:author/atom:uri@href"/></xsl:attribute>LinkedIn</a>, <a href="https://www.facebook.com/profile.php?id=61555497917112">Facebook</a>)<xsl:text>&gt;</xsl:text>
          </div>          
